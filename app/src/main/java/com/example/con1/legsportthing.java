...
public class legsportthing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legsportthing);
        ...
        View.OnClickListener status7 = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                rb7.setChecked(true);
                Intent intent = new Intent(legsportthing.this, congrattext.class);
