...
public class sportthing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sportthing);
        ...
        View.OnClickListener status7 = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                rb7.setChecked(true);
                Intent intent = new Intent(sportthing.this, congrattext.class);
